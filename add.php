...
<h1 align=center style="font-family:cambria;font-size:20">GETTING EXTRA!!</h1>
<?php
$conn=mysql_connect("localhost","root","student");
mysql_select_db("web",$conn);
$sql="select * from add0n";
$resultSet=mysql_query($sql,$conn);
echo "<table  border='3' cellspacing='5' cellpadding='5'  height='35%' width='65%' style='margin-top:-2s0px;margin-left:80px'>";
echo "<tr style='font-family:cambria' align=center><td>Sr NO.</td><td>COURSE NAME</td><td>COURSE DURATION</td><td>FACULTY NAME</td><td>COURSE FEES</td></tr>";
$i=1;
while($row=mysql_fetch_array($resultSet))
{
echo "<tr align=center><td>$i</td><td style='font-family:cambria'>$row[course_name]</td><td>$row[course_duration]</td><td>$row[faculty_name]</td><td>$row[course_fees]</td></tr>";
$i++;
}
echo "</table>"
?>
