...
<table cellpadding="5" cellsapcing="5" height="50%" width=45%" style="margin-top:-285px;margin-left:370px;">
	<tr><td style="font-family:cambria;font-size:20">
               <img src="lib1.png"  align="left" style="margin-bottom:120px">
<?php
...
echo "<tr><th style='font-family:arial'>LIBRARY</th></tr>";
$row=mysql_fetch_array($resultSet);
echo "<tr><td style='font-family:cambria'>$row[library]</td></tr>";
echo "</table>"
?>
</td></tr>
</table>
