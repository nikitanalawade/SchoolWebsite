...
<center>
<br></br>
<table border="2" bgcolor="black" cellpadding="5" cellsapcing="50" height="25%" width="75%" style="margin-top:-30px">
...
<table  cellpadding="5" cellsapcing="5" height="50%" width="55%" style="margin-top:-285px;margin-left:250px;">
	<td align="center"><img src="girls.png"></td></tr>
</table>
...
<table cellpadding="5" cellsapcing="5" height="50%" width=45%" style="margin-top:-285px;margin-left:370px;">
	<tr><td style="font-family:monotype corsiva;font-size:20">	<img src="school.png" 	align=left>.  Founded in 1952 and run 	by the Religious of Jesus & Mary, which in turn was 		founded 	by St.    Claudine    Thevenet.<br>
	.  A English medium girls' high school with classes from Nursery to std. X.<br>
	.  Affiliated to Maharashtra State Board of Secondary Education.<br>
	.  It is a Maharashtra Government aided Convent school .<br>
	.  Education is free from Std. V to X as per the rules of the State Government.<br>
	.  Open to pupils of all castes & creeds and from all social 	& financial backgrounds.<br> 
	.  School aims at imparting a sound education for all round   development of the child.</td></tr>
</table>
