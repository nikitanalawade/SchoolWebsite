...
<table cellpadding="5" cellsapcing="5" height="50%" width=45%" style="margin-top:-285px;margin-left:370px;">
	<tr><td style="font-family:cambria;font-size:20">
             <img src="slab4.png"  align="left" style="margin-top:-30px;margin-left:-10px"">
	<img src="clab3.png"  align="left" style="margin-top:120px;margin-left:-175px">
<?php
$conn=mysql_connect("localhost","root","student");
mysql_select_db("web",$conn);
$sql="select * from facilities";
$resultSet=mysql_query($sql,$conn);
echo "<table  cellspacing='5' cellpadding='5'  height='35%' width='65%' style='margin-top:-20px'>";
echo "<tr><th style='font-family:arial'>LABORATORY</th></tr>";
$row=mysql_fetch_array($resultSet);
echo "<tr><td style='font-family:cambria'>$row[lab]</td></tr>";
echo "</table>"
?>
</td></tr>
</table>
