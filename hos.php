...
<table  cellpadding="5" cellsapcing="5" height="50%" width="55%" style="margin-top:-285px;margin-left:250px;">
	<td align="center"><img src="hostel.png"></td></tr>
</table>
...
echo "<table   cellspacing='5' cellpadding='5'   width='105%' 
style='margin-top:-15px;margin-left:-10px'>";
echo "<tr><th style='font-family:arial'>HOSTEL</th></tr>";
$row=mysql_fetch_array($resultSet);
echo "<tr><td style='font-family:cambria'>$row[hostel]</td></tr>";
echo "</table>"
?>
</td></tr>
</table>
