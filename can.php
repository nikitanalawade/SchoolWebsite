...
<table cellpadding="5" cellsapcing="5" height="50%" width=45%" style="margin-top:-285px;margin-left:370px;">
	<tr><td style="font-family:cambria;font-size:20">
                <h1 style="margin-top:-ss100px"><img src="canteen1.png"></h1>
...
echo "<table cellspacing='5' cellpadding='5'  height='35%' width='65%' style='margin-top:-170px;margin-left:200px'>";
echo "<tr><th style='font-family:arial'>CANTEEN</th></tr>";
$row=mysql_fetch_array($resultSet);
echo "<tr><td style='font-family:cambria'>$row[canteen]</td></tr>";
echo "</table>"
?>
</td></tr>
</table>
